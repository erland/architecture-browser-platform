import type { FullSnapshotEntity, FullSnapshotRelationship, FullSnapshotViewpoint } from './appModel';
import type { BrowserSnapshotIndex } from './browserSnapshotIndex.types';
import { compactScopeDisplayName, displayNameOf } from './browserSnapshotIndex.display';
