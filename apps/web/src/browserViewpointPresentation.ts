...
import type { BrowserViewpointVariant } from './browserSnapshotIndex';
import type { BrowserSessionState, BrowserViewpointPresentationPreference } from './browserSessionStore';
