...
jest.mock('../views/useBrowserSavedCanvasController', () => ({
  useBrowserSavedCanvasController: () => mockSavedCanvasController,
}));

jest.mock('../views/useBrowserViewActions', () => ({
  useBrowserViewActions: () => mockBrowserActions,
}));

jest.mock('../views/useBrowserViewLayout', () => ({
  useBrowserViewLayout: () => mockBrowserLayout,
}));

jest.mock('../snapshotCache', () => ({
  getBrowserSnapshotCache: () => mockSnapshotCache,
}));

import { useBrowserViewScreenController } from '../views/useBrowserViewScreenController';
