...
import { addDependenciesToCanvas, addEntityToCanvas, addScopeToCanvas, arrangeAllCanvasNodes, arrangeCanvasAroundFocus, toggleCanvasNodePin } from '../../browser-session/canvas-api';
