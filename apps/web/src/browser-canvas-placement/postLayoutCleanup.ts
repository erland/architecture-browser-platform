import { COLLISION_MARGIN, GRID_X, GRID_Y, roundToGrid } from '../browser-graph/canvas/stage';
import type { BrowserAutoLayoutCleanupIntensity } from '../browser-auto-layout/stage';
