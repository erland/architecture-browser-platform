...
function buildBalancedClusters(
  componentNodes: BrowserAutoLayoutNode[],
  edges: BrowserAutoLayoutEdge[],
...
function buildBalancedClusterConnectionGraph(
  clusters: BalancedCluster[],
  edges: BrowserAutoLayoutEdge[],
...
function buildBalancedClusterRows(
  clusters: BalancedCluster[],
...
function placeBalancedClusters(
  arranged: BrowserCanvasNode[],
