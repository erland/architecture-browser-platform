...
import { createPersistedBrowserSessionState, hydrateBrowserSessionState } from './browserSessionStore.state';
import { normalizeFocusedBrowserContext, normalizeSearchScopeId, recomputeBrowserSearchState } from './browserSessionStore.invariants';
import type {
